...
[Magento 2 Custom Order Number](https://www.ulmod.com/custom-order-number-for-magento-2.html)  is a Magento 2 extension that allows you to easily change/customize your order, invoice, shipment, and credit memo numbers.

With Magento 2 Custom Order Number, you can use prefixes, suffixes, and any combination of numbers, letters, and date/time variables in your order, invoice, shipment, and credit memo numbers.

<a href="https://www.ulmod.com/custom-order-number-for-magento-2.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Ability to change/customize order, shipment, invoice and credit memo numbers 
* Support any combination of letters, numbers, and dates/times 
* Support custom increments for order, invoice, shipment, and credit memo
* Ability to use the same number for invoices, shipping, and credit memos
* Ability to use a custom starting number for the counter
* Ability to set the length of order numbers via custom padding
* Reset counter manually per day, month or year
* Auto-reset the counter, daily, monthly, and yearly
* Support multiple-stores


<img src="https://www.ulmod.com/media/ulmod/product_content/custm-on-p-main.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/custm-on-p-admin1.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/custm-on-p-admin2.png">
